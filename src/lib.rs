// src/lib.rs
/*
 * Core library for OrderProcessor
 */
...
#[derive(Debug)]
pub struct OrderProcessorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OrderProcessorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OrderProcessor processing");
    
    let mut processor = OrderProcessorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OrderProcessorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OrderProcessorProcessor::new(false);
